...
echo "Running JIRA Api script"
echo "## This is a experimental and incomplete scripts!!"
echo "-> No responsibility taken by developer"
...
if [[ -z $JIRA_HOST ]]; then
	read -p "Enter your JIRA domain (eg: https://[name].atlassian.net): " JIRA_HOST
fi
JIRA_URL="https://${JIRA_HOST}.atlassian.net"
